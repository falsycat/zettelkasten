...
- ノート間のリンクは多ければ多いほど良い。新規ノート同士だけでなく、関連する既存ノートへも積極的にリンクする
...
- 今回作成したノートだけで新しいクラスタ番号が構成されている場合、既存クラスタから孤立している
- 孤立している場合、内容が関連する既存ノートを探し、新規ノートから既存ノートへのリンクを追加して結合する（既存ノート自体は変更しない）
- 全ての新規ノートが既存クラスタのいずれかに属するまで繰り返す
